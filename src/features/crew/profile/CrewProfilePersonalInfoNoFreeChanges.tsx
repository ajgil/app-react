    ...
    <div className="w-full min-h-screen bg-[#fff] flex overflow-x-hidden leading-[normal] tracking-[normal] text-left text-base text-[#1849d6] font-[Inter]">
      ...
      <div className="flex-1 ml-[260px] flex flex-col min-h-screen">
        ...
        <main className="flex-1 p-6">
          <div className="max-w-[1200px] mx-auto flex flex-col gap-[22px]">
            ...
            {/* Tabs & Form Social Card */}
            <section className="self-stretch flex flex-col gap-6 max-w-full">
              <div className="shadow-sm rounded-xl bg-white border border-[#e0f2fe] overflow-hidden flex flex-col">
                {/* Tabs Wrapper */}
                <div className="flex items-center justify-center py-4 px-4 bg-white border-b border-[#f3f3f3]">
                  <div className="shadow-sm rounded-lg border border-[#e9eaeb] overflow-hidden flex">
                    <div className="bg-[#f3f3f3] border-r border-[#e9eaeb] py-2.5 px-6 font-bold text-[#212121]">Personal Info</div>
                    <div className="bg-white border-r border-[#e9eaeb] py-2.5 px-6 font-medium text-[#727272]">Experience</div>
                    <div className="bg-white border-r border-[#e9eaeb] py-2.5 px-6 font-medium text-[#727272]">Certificates</div>
                    <div className="bg-white py-2.5 px-6 font-medium text-[#727272]">{`CV & Docs`}</div>
                  </div>
                </div>
                ...
                <div className="p-6 flex flex-col gap-8 bg-white">
                  ...
                  {/* Input Grid: MASTER RULES - Cleanup numbered Grid classes */}
                  ...
                  <div className="flex flex-col gap-4 pt-4 border-t border-[#f3f3f3]">
